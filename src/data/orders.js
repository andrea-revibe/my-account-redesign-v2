...
// keep it stable.
//
// `placedAt` is the canonical machine date (DD/MM/YYYY HH:MM AM/PM).
// `placedAtFull` is the human-readable long form rendered inside the Order
// details collapse on each card.
