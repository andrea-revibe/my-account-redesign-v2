...
| `components/InvalidClaimCard.jsx` | 796 | 1 | `InvalidClaimCard`·41 |
...
_Generated by `scripts/codemap.mjs` — 88 modules, 24817 LOC. Re-run after structural changes; do not hand-edit between the markers._
