...
| `components/ClaimFlow/ResetGuideSheet.jsx` | 794 | 1 | `ResetGuideSheet`·424 |
...
| `components/ClaimFlow/Step7Confirmation.jsx` | 211 | 1 | `Step7Confirmation`·15 |
...
_Generated by `scripts/codemap.mjs` — 77 modules, 22517 LOC. Re-run after structural changes; do not hand-edit between the markers._
