...
| `components/ProductSummary.jsx` | 154 | 17 | `REVIBE_CARE_ICON`·1, `ProductSummary`·20 |
...
_Generated by `scripts/codemap.mjs` — 101 modules, 27423 LOC. Re-run after structural changes; do not hand-edit between the markers._
