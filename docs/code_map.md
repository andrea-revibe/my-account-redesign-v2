...
| `components/ClaimCard.jsx` | 361 | 1 | `ClaimCard`·47 |
...
_Generated by `scripts/codemap.mjs` — 94 modules, 26233 LOC. Re-run after structural changes; do not hand-edit between the markers._
