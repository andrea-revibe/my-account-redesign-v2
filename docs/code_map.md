...
| `components/ClaimFlow/IssueEvidence.jsx` | 452 | 1 | `IssueEvidence`·63 |
...
| `components/ClaimFlow/flowReducer.js` | 405 | 2 | `BRANCH_ENTRY`·29, `sequenceFor`·58, `claimTypeFor`·66, `progressFor`·110, `initialState`·128, `flowReducer`·225, `stepError`·330, `canAdvance`·402 |
| `components/ClaimFlow/issueTaxonomy.js` | 438 | 7 | `PROOF_GUIDE_LABEL`·22, `DEFAULT_PROOF_GUIDE_URL`·25, `ISSUE_CATEGORIES`·116, `WRONG_ITEM_DETAILS`·317, `SOMETHING_ELSE_ID`·346, `categoryById`·361, `findSpecificIssue`·365, `categoryForIssue`·373, `scopeForIssue`·379, `visibleIssuesFor`·391, `labelForIssue`·399, `resolveNeed`·410, `evidenceSubFor`·425 |
...
_Generated by `scripts/codemap.mjs` — 100 modules, 27189 LOC. Re-run after structural changes; do not hand-edit between the markers._
